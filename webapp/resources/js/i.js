//<script>
if (!window.bouncex) { (function(){ 	 
	window.bouncex = {};
	bouncex.website = {"ei":0,"cookie_name":"bounceClientVisit355","base_host":"assets.bounceexchange.com","vars":{"is_doorbuster":{"val":"document.getElementById('price-table')&&document.getElementById('price-table').innerText.indexOf('Doorbuster')>0?'true':'false'","polling":"none","default":""},"is_deal_day":{"val":"document.getElementById('price-table')&&document.getElementById('price-table').innerText.indexOf('Deal of the Day')>0?'true':'false'","polling":"none","default":""}},"acts":[],"pi":1000,"ct":"multi_cookie","tcjs":"","cjs":"","PMI":500,"PDI":1000,"PMR":30,"force_https":false,"waypoints":false,"gai":"UA-208976-2","ots":60,"sd":0,"aco":{"first_party_limit":"3500"},"id":355,"campaign_id":0,"tpc":0,"uwc":0,"domain":"jomashop.com","bau":"api.bounceexchange.com","is_preview":false,"mas":2,"map":1,"burls":[],"ese":false,"ibx":{"cjs":"","miw":"0","mibcx":0,"te":0,"tjs":"","cart_rep":{"get":"","set":""}}};
...
function init_cookie() {
	var c = getBounceCookie();
	try { 
		bouncex.cookie = bouncex.parseJSON(c);
	} catch (e) {
		bouncex.cookie = {};
	}
}
