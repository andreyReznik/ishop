...
<dt class="filter-header user-select-none odd">Brand<span class="jq-selected-filters-mob"></span></dt>
<dd class="filter-body brands-filter odd" style="display: none;">
<div class="brand-search-box"><input autofocus="" autocomplete="off" placeholder="Begin typing to search by brand"
...
<div class="slimScrollBar" style="width: 9px; position: absolute; top: 0px; opacity: 1; display: block; border-radius: 9px; z-index: 99; right: 1px; height: 30px; background: rgb(65, 76, 92);"></div>
<div class="slimScrollRail" style="width: 9px; height: 100%; position: absolute; top: 0px; display: block; border-radius: 7px; opacity: 1; z-index: 90; right: 1px; background: rgb(243, 244, 246);"></div>
</div>
</dd>
</div>
<div class="filter-item" id="jQfilterItem_4">
    <dt class="filter-header user-select-none even">Gender<span class="jq-selected-filters-mob"></span></dt>
...
<div class="filter-item" id="jQfilterItem_7">
    <dt class="filter-header user-select-none odd">Movement<span class="jq-selected-filters-mob"></span></dt>
...
<div class="filter-item" id="jQfilterItem_9">
    <dt class="filter-header user-select-none odd">Price<span class="jq-selected-filters-mob"></span></dt>
    <dd class="filter-body  odd" style="display: none;">
    ...
    <div class="sort-by text-right cat-sort-by">
        ...
        <div class="fixedWidth">
            <%--<span style="-moz-user-select: none;">--%>
                    <%--Most Viewed                </span>--%>
            <select onChange="alert('not implemented yet')" style="float:right;height:30px;text-transform:uppercase;width:215px;padding:0px 7px;">
    ...
    <%--<div class="footer">--%>
        <%--<div class="footer-top">--%>
            <%--<form action="email-preference-center" method="get">--%>
                <%--&lt;%&ndash;<div class="form-subscribe">&ndash;%&gt;--%>
                    <%--&lt;%&ndash;<div class="form-subscribe-header">&ndash;%&gt;--%>
                        <%--&lt;%&ndash;<label for="newsletter">Enter your email address to get updates<span&ndash;%&gt;--%>
                                <%--&lt;%&ndash;class="no-display-mob">:</span></label>&ndash;%&gt;--%>
                    <%--&lt;%&ndash;</div>&ndash;%&gt;--%>
                    <%--&lt;%&ndash;<div class="v-fix"><input name="email" id="newsletter"&ndash;%&gt;--%>
                                              <%--&lt;%&ndash;class="input-text required-entry validate-email"&ndash;%&gt;--%>
                                              <%--&lt;%&ndash;placeholder="Email Address" type="email">&ndash;%&gt;--%>
                        <%--&lt;%&ndash;<button type="submit" class="button" title="Sign Up"><span><span></span></span></button>&ndash;%&gt;--%>
                    <%--&lt;%&ndash;</div>&ndash;%&gt;--%>
                    <%--&lt;%&ndash;<p class="jqMessage" style="display:none;"></p>&ndash;%&gt;--%>
                <%--&lt;%&ndash;</div>&ndash;%&gt;--%>
            <%--</form>--%>
            <%--&lt;%&ndash;<div class="social-media-icons"><a class="footer-face-book-ic" href="https://www.facebook.com/ishop"&ndash;%&gt;--%>
                                               <%--&lt;%&ndash;target="_blank"></a> <a class="footer-twitter-ic"&ndash;%&gt;--%>
                                                                       <%--&lt;%&ndash;href="https://twitter.com/ishop"&ndash;%&gt;--%>
                                                                       <%--&lt;%&ndash;target="_blank"></a><a&ndash;%&gt;--%>
                    <%--&lt;%&ndash;class="footer-pinterest-ic" href="http://www.pinterest.com/ishop/" target="_blank"></a> <a&ndash;%&gt;--%>
                    <%--&lt;%&ndash;class="footer-googleplus-ic" href="https://plus.google.com/+ishop" target="_blank"></a></div>&ndash;%&gt;--%>
        <%--</div>--%>
        <%--<script type="text/javascript">--%>
            <%--//<![CDATA[--%>
...
<%--</script>--%>
<%--&lt;%&ndash;<iframe name="google_conversion_frame" title="Google conversion frame"&ndash;%&gt;--%>
        <%--&lt;%&ndash;src="${ctx}/htm/a.htm"&ndash;%&gt;--%>
        <%--&lt;%&ndash;marginwidth="0" marginheight="0" vspace="0" hspace="0" allowtransparency="true" scrolling="no" frameborder="0"&ndash;%&gt;--%>
        <%--&lt;%&ndash;height="13" width="300">&lt;img&ndash;%&gt;--%>
    <%--&lt;%&ndash;height="1" width="1" border="0" alt=""&ndash;%&gt;--%>
    <%--&lt;%&ndash;src="/product/notImpl/"&ndash;%&gt;--%>
    <%--&lt;%&ndash;/&gt;</iframe>&ndash;%&gt;--%>
<%--<noscript>--%>
    <%--&lt;%&ndash;<div style="display:inline;">&ndash;%&gt;--%>
        <%--&lt;%&ndash;<img height="1" width="1" style="border-style:none;" alt=""&ndash;%&gt;--%>
             <%--&lt;%&ndash;src="//googleads.g.doubleclick.net/pagead/viewthroughconversion/1072367177/?value=0&amp;guid=ON&amp;script=0&amp;data=ecomm_pagetype%3Dcategory%3Becomm_category%3DMen%27s+Watches"/>&ndash;%&gt;--%>
    <%--&lt;%&ndash;</div>&ndash;%&gt;--%>
<%--</noscript>--%>
