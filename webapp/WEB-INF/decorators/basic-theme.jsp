...
<%--<img src="${ctx}/img/img.gif"--%>
<%--alt="" style="border-style: none;" height="1" width="1">--%>
<script src="${ctx}/js/action2.js"
        async="" type="text/javascript"></script>
<script src="${ctx}/aspx/Dynamic.aspx"
        async="" type="text/javascript"></script>
<script src="${ctx}/other/521071e652"
        type="text/javascript"></script>
<script src="${ctx}/js/vms.js"
        async="" type="text/javascript"></script>
<script src="${ctx}/js/nr-632.js"></script>
<script src="${ctx}/aspx/Static.aspx"
        async="" type="text/javascript"></script>
...
<script src="${ctx}/js/linkid.js"
        async="" type="text/javascript"></script>
<script async=""
        src="${ctx}/js/bat.js"></script>
<script src="${ctx}/js/analytics.js"
        async=""></script>
<script src="${ctx}/js/rollover.js"
        async="" type="text/javascript"></script>
<script src="${ctx}/js/script.js"
        async="" id="ftr__script" type="text/javascript"></script>
<script src="${ctx}/js/gtm.js"
        async=""></script>
<script src="${ctx}/js/ga.js"
        async="" type="text/javascript"></script>
<script src="${ctx}/js/gate.js"
        async="" type="text/javascript"></script>
<script type="text/javascript">(window.NREUM || (NREUM = {})).loader_config = {xpid: "Uw4HWVFSGwAJV1VRAgY="};
window.NREUM || (NREUM = {}), __nr_require = function (t, e, n) {
...
}, {1: 5, 2: 8, 3: 3, 4: 7, 5: 6, 6: 21, ee: "QJf3ax", handle: "D5DuLP", loader: "G9z0Bl"}], 5: [function (t, e) {
    function n(t) {
    ...
    var a = t("ee").create(), s = t(1), c = t(2), u = c(a), f = c(s), d = window.XMLHttpRequest, p = ["onload", "onerror", "onabort", "onloadstart", "onloadend", "onprogress", "ontimeout"];
...
}, {1: 5, 2: 22, ee: "QJf3ax"}], 9: [function (t) {
    function e(t) {
        ...
        if (!this.ended) {
            ...
            if (!e.aborted) {
                if (r.duration = (new Date).getTime() - this.startTime, 4 === t.readyState) {
                    e.status = t.status;
                    var a = t.responseType, u = "arraybuffer" === a || "blob" === a || "json" === a ? t.response : t.responseText, f = n(u);
...
}, {1: "XL7HBI", 2: 10, 3: 8, 4: 5, ee: "QJf3ax", handle: "D5DuLP", loader: "G9z0Bl"}], 10: [function (t, e) {
...
}, {1: 20, 2: 21, handle: "D5DuLP"}], "7eSDFh": [function (t, e) {
function n(t, e, n) {
...
function n() {
var t = p.info = NREUM.info, e = u.getElementsByTagName("script")[0];
...
var a = t("handle"), s = t(1), c = (t(2), window), u = c.document, f = ("" + location).split("?")[0], d = {beacon: "bam.nr-data.net", errorBeacon: "bam.nr-data.net", agent: "js-agent.newrelic.com/nr-632.min.js"}, p = e.exports = {offset: i(), origin: f, features: {}};
...
}, {1: 20, 2: 11, handle: "D5DuLP"}], loader: [function (t, e) {
e.exports = t("G9z0Bl")
}, {}], 20: [function (t, e) {
function n(t, e) {
var n = [], o = "", i = 0;
...
}, {1: 21, ee: "QJf3ax"}]}, {}, ["G9z0Bl", 4, 9]);</script>
<title>Watches</title>
...
<link rel="stylesheet" type="text/css"
      href="${ctx}/css/5d5c79202b902c624aaecd21a0bcb95d.css"
      media="all">
<link rel="stylesheet" type="text/css"
      href="${ctx}/css/9f4acea2d81f4b308a9cf68678a49835.css"
      media="print">
<script type="text/javascript"
        src="${ctx}/js/bb850ad85599d6b8411a0b1bc6949788.js"></script>
<script src="${ctx}/js/jquery.js"></script>
<!--[if lt IE 8]>
<link rel="stylesheet" type="text/css" href="${ctx}/css/916253448a33341a40cba7ec338d6c75.css"
media="all"/>
<![endif]-->
<!--[if lt IE 7]>
<script type="text/javascript" src="${ctx}/js/e3a784cb433c56e4182544d075b1e2e7.js"></script>
<![endif]-->

<script type="text/javascript">
    //<![CDATA[
    Mage.Cookies.path = '/';
    Mage.Cookies.domain = '.www.ishop.com';
    //]]>
</script>
...
<style type="text/css">.mblistrowleft {
    cssFloat:;
    text-align:;
}
...
<link rel="stylesheet" type="text/css"
      href="${ctx}/css/sli-rac.css">
<link rel="stylesheet" type="text/css"
      href="${ctx}/css/sli-rac_002.css">
<script type="text/javascript">
    var ajaxsearch = true;
    var slibaseurlsearch = '/product/notImpl';
</script>
...
<script type="text/javascript">
    if (typeof ROITracker === 'undefined') {
        ...
        ROIStorage.q = [];
        window.ga = function () {
            ROIStorage.q.push(arguments)
        };
        window.ga.q = window.ga.q || [];
        ROIStorage.roiq = [];
        ROIStorage.analyticsJsNotLoaded = true;
        window.ga.q.push([function () {
            var e;
            ROIStorage.realGa = window.ga;
            ROIStorage.analyticsJsNotLoaded = false;
            window.ga = function () {
                if (typeof arguments[0] === 'function') {
                    ROIStorage.realGa(arguments)
                } else {
                    ROIStorage.q.push(arguments)
                }
            };
            ROIStorage.roiq.push = function () {
                ROIStorage.realGa.apply(window, arguments)
            };
            for (e = 0; e < ROIStorage.roiq.length; e += 1) {
                ROIStorage.realGa.call(window, ROIStorage.roiq[e])
            }
        }])
    }
    ROIStorage.gaq = ROIStorage.gaq || [];
    window._gaq = {push: function () {
        var e;
        for (e = 0; e < arguments.length; e++) {
            ROIStorage.gaq.push(arguments[e])
        }
    }};
    (function () {
        ...
        ga.async = true;
        ga.src = ('https:' == document.location.protocol ? 'https://6e4c548051a2e66abb39-e161dcf9dc9a4ac06eb014a5acdc26b8.ssl.cf2.rackcdn.com/gate.js' : 'http://b8f75515d5841d8636de-e161dcf9dc9a4ac06eb014a5acdc26b8.r56.cf2.rackcdn.com/gate.js');
...
<script>
    (function (d) {
        ...
        e.src = d.location.protocol + '//bounceexchange.com/tag/355/i.js';
        e.async = true;
        d.getElementsByTagName("head")[0].appendChild(e);
    }(document));
</script>
<script async=""
        src="${ctx}/js/i.js"></script>
...
<script type="text/javascript">
    ...
    _gaq.push(['_setAccount', 'UA-55282558-1']);
...
<!-- Google Tag Manager -->
<script>dataLayer = [
    {"visitorLoginState": "Logged out", "visitorType": "NOT LOGGED IN", "visitorLifetimeValue": 0, "visitorExistingCustomer": "No"}
];</script>

<noscript>
    <iframe src="//www.googletagmanager.com/ns.html?id=GTM-KH8S7K"
            ...
            <div class="header">
                ...
                <div class="top-links-joma">
                    ...
                    <div class="top-links-cont">
                        ...
                        <%--<ul class="links">--%>
                        <%--<li class="first"><a class="jqLogin" href="#login-modal" id="" title="Log In">Log In</a>--%>
                        <%--</li>--%>
                        <%--<li class=" last"><a class="jqLogin" href="#register-modal" id=""--%>
...
<div>
        ...
        <script type="text/javascript">
            (function () {
                ...
                var ftr = document.createElement('script');
                ftr.type = 'text/javascript';
                ftr.id = 'ftr__script';
                ftr.async = true;
                ftr.src = ('https:' == document.location.protocol ? 'https:' : 'http:') + '//cdn4.forter.com/script.js?sn=d379f257f86d';
                var s = document.getElementsByTagName('script')[0];
                s.parentNode.insertBefore(ftr, s);
            })();
        </script>
        <script type="text/javascript">
            arrEcjs = [];
        ...
        <script type="text/javascript"
                src="${ctx}/js/sli-rac_002.js"></script>
        <p class="saSchema">
        </p>
        ...
        <script type="text/javascript">
            ...
            var google_tag_params = {
                ...
                ecomm_category: "Men's Watches"
            };
            var google_conversion_id = 1072367177;
            var google_custom_params = google_tag_params;
            var google_remarketing_only = true;
            /* ]]> */
        </script>
        <script type="text/javascript"
                src="${ctx}/js/conversion.js">
        </script>
        <%--<iframe name="google_conversion_frame" title="Google conversion frame"--%>
        <%--src="${ctx}/htm/a.htm"--%>
        <%--marginwidth="0" marginheight="0" vspace="0" hspace="0" allowtransparency="true" scrolling="no" frameborder="0"--%>
        <%--height="13" width="300">&lt;img--%>
        ...
        <noscript>
            ...
            <%--src="//googleads.g.doubleclick.net/pagead/viewthroughconversion/1072367177/?value=0&amp;guid=ON&amp;script=0&amp;data=ecomm_pagetype%3Dcategory%3Becomm_category%3DMen%27s+Watches"/>--%>
            <%--</div>--%>
        </noscript>
...
NREUM.info = {"beacon": "bam.nr-data.net", "licenseKey": "521071e652", "applicationID": "3934357", "transactionName": "MldWYRMDX0VUAkMLDAsddVYVC15YGgJWFgIJXVMaAgNFU1IORRtME1tRQg==", "queueTime": 0, "applicationTime": 2950, "atts": "HhBVF1sZTEs=", "errorBeacon": "bam.nr-data.net", "agent": "js-agent.newrelic.com\/nr-632.min.js"}</script>
