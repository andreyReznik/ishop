...
<c:forEach var="watch" items="${watches}">
    <tr class="first last">
        <td>${watch.id}</td>
        <td><img class="imgColumn" src="${watch.mainImage}" alt="watch image"></td>
        <td>${watch.info}</td>
        <td>
        ...
        <td class="a-center last">
            <a href="#"
               onclick="adminOperationsHelper.getProductDataForEdit('/admin/product',${watch.id})"
               title="Edit">
        ...
        <td class="a-center cart-item-remove last">
            <a href="#"
               onclick="adminOperationsHelper.deleteProduct('/admin/product',${watch.id})"
               title="Remove"
